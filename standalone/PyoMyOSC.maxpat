{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 0.0, 57.0, 535.0, 662.0 ],
        "openrect": [ 0.0, 0.0, 535.0, 662.0 ],
        "openrectmode": 0,
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "save": [ "#N", "thispatcher", ";", "#Q", "window", "flags", "nogrow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 0, 57, 535, 719, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
                    "text": "thispatcher"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 240.0, 342.0, 47.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "parameter_enable": 0,
                    "patching_rect": [ 240.0, 286.0, 39.0, 41.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 195.0, 52.0, 17.0, 17.0 ]
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 240.0, 288.0, 39.0, 39.0 ],
                    "pic": "/Users/Home/Downloads/email (1).png",
                    "presentation": 1,
                    "presentation_rect": [ 196.0, 53.0, 15.0, 15.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 134.0, 94.0, 5.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 12.0, 369.0, 513.0, 5.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 127.0, 94.0, 5.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 12.060301780700684, 77.88944900035858, 511.55780053138733, 5.025125741958618 ],
                    "saved_attribute_attributes": {
                        "linecolor": {
                            "expression": ""
                        }
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 198.0, 422.0, 115.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 334.04328924417496, 4.5618555545806885, 115.0, 18.0 ],
                    "text": "- Connect BLE dongles",
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 149.0, 95.0, 112.0, 19.364182568940805 ],
                    "presentation": 1,
                    "presentation_rect": [ 78.0, 50.0, 114.7237568795681, 21.259640097618103 ],
                    "rounded": 10.0,
                    "saved_attribute_attributes": {
                        "activebgcolor": {
                            "expression": ""
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 149.0, 127.0, 59.0, 22.0 ],
                    "saved_object_attributes": {
                        "fontname": "Ableton Sans Medium"
                    },
                    "text": "p website"
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 485.0, 232.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 231.95874989032745, 57.73195552825928, 232.0, 18.0 ],
                    "text": "3. (Optional) Set OSC send/receive parameters",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 465.0, 283.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 231.95874989032745, 42.268038868904114, 283.0, 18.0 ],
                    "text": "2. Run source .venv/bin/activate, and then pyomyosc.py",
                    "textcolor": [ 1.0, 0.886274509803922, 0.537254901960784, 0.901960784313726 ],
                    "varname": "text[4]"
                }
            },
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 1015.0, 253.0, 159.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 299.0, 201.0, 110.0, 35.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 618.0, 64.0, 56.0, 22.0 ],
                                    "text": "deferlow"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 680.0, 201.0, 105.0, 35.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 228.0, 253.0, 250.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 605.0, 253.0, 385.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 816.0, 40.0, 160.0, 49.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 816.0, 113.0, 182.0, 49.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "bang" ],
                                    "patching_rect": [ 605.0, 40.0, 58.0, 22.0 ],
                                    "text": "loadbang"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 564.0, 253.0, 29.5, 22.0 ],
                                    "text": "title",
                                    "textcolor": [ 1.0, 1.0, 1.0, 1.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 50.0, 253.00000000000006, 61.0, 22.0 ],
                                    "text": "topmost 0",
                                    "textcolor": [ 1.0, 1.0, 1.0, 1.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 496.0, 253.0, 42.0, 22.0 ],
                                    "text": "title \" \"",
                                    "textcolor": [ 1.0, 1.0, 1.0, 1.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 122.56883563563264, 253.00000000000006, 93.0, 22.0 ],
                                    "text": "title PyoMyOSC",
                                    "textcolor": [ 1.0, 1.0, 1.0, 1.0 ]
                                }
                            },
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 50.0, 334.00000000000006, 30.0, 30.0 ]
                                }
                            }
                        ],
                        "lines": [
                            {
                                "patchline": {
                                    ...
                                    "midpoints": [ 505.5, 321.0, 59.5, 321.0 ],
                                    "source": [ "obj-12", 0 ]
                                }
                            },
                            {
                            ...
                            },
                            {
                                "patchline": {
                                    ...
                                    "midpoints": [ 614.5, 62.99999999999994, 614.5, 62.99999999999994 ],
                                    "source": [ "obj-16", 0 ]
                                }
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-22", 0 ],
                                    "midpoints": [ 614.5, 321.0, 59.5, 321.0 ],
                                    "source": [ "obj-17", 0 ]
                                }
                            },
                            {
                                "patchline": {
                                    ...
                                    "midpoints": [ 237.5, 71.99999999999994, 237.5, 71.99999999999994 ],
                                    "source": [ "obj-19", 0 ]
                                }
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-22", 0 ],
                                    "midpoints": [ 237.5, 321.0, 59.5, 321.0 ],
                                    "source": [ "obj-20", 0 ]
                                }
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-22", 0 ],
                                    "midpoints": [ 573.5, 321.0, 59.5, 321.0 ],
                                    "source": [ "obj-28", 0 ]
                                }
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-22", 0 ],
                                    "midpoints": [ 132.06883563563264, 321.0, 59.5, 321.0 ],
                                    "source": [ "obj-4", 0 ]
                                }
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-22", 0 ],
                                    "midpoints": [ 1024.5, 321.0, 59.5, 321.0 ],
                                    "source": [ "obj-5", 0 ]
                                }
                            }
                        ]
                    },
                    "patching_rect": [ 240.0, 214.0, 60.0, 22.0 ],
                    "text": "p settings"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 445.0, 226.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 232.47421377897263, 27.319586098194122, 226.0, 18.0 ],
                    "text": "1. Open Terminal, and navigate to /pyomyosc",
                    "textcolor": [ 1.0, 0.886274509803922, 0.537254901960784, 0.901960784313726 ],
                    "varname": "text[2]"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 141.0, 94.0, 5.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 231.44328600168228, 25.773194432258606, 217.60000324249268, 5.0 ],
                    "saved_attribute_attributes": {
                        "linecolor": {
                            "expression": ""
                        }
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 148.0, 94.0, 5.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 12.000000357627869, 51.00000151991844, 217.3333398103714, 5.333333492279053 ],
                    "saved_attribute_attributes": {
                        "linecolor": {
                            "expression": ""
                        }
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 101.0, 95.6820912844704, 44.0, 18.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 36.0, 52.0, 44.0, 18.0 ],
                    "text": "© 2026",
                    "textcolor": [ 1.0, 1.0, 1.0, 1.0 ],
                    "textjustification": 1,
                    "varname": "text[1]"
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 40.5, 34.99999999999994, 148.0, 38.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 12.400000184774399, 8.0, 217.2000032365322, 38.0 ],
                    "text": "PyoMyOSC",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 50.0, 420.0, 37.0, 23.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 234.02060544490814, 2.0618555545806885, 37.0, 23.0 ],
                    "text": "info",
                    "textcolor": [ 1.0, 1.0, 1.0, 1.0 ],
                    "textjustification": 1,
                    "varname": "text"
            ...
            },
            {
                "box": {
                    ...
                    "lockedsize": 0,
                    "maxclass": "bpatcher",
                    "name": "p-pyomyosc.maxpat",
                    "numinlets": 0,
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 41.0, 300.0, 97.0, 64.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 1.0, 369.0, 533.0, 292.0 ],
                    "varname": "p-myo[2]",
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 41.0, 219.0, 97.0, 64.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 1.0, 78.0, 533.0, 292.0 ],
                    "varname": "p-myo[1]",
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 240.0, 165.0, 24.0, 24.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 41.0, 165.0, 67.0, 22.0 ],
                    "saved_object_attributes": {
                        "allwindowsactive": 0,
                        "appicon_mac": "",
                        "appicon_win": "",
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 158.5, 117.8095074097028, 158.5, 117.8095074097028 ],
                    "source": [ "obj-21", 0 ]
                }
            },
            {
