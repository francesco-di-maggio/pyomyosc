        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1214.0, 24.0, 38.0, 20.0 ],
                    "text": "on/off"
                }
            },
            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 561.5, 48.0, 561.5, 48.0 ],
                    "source": [ "obj-22", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-61", 1 ],
                    "midpoints": [ 799.5, 60.0, 561.5, 60.0 ],
                    "source": [ "obj-37", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-61", 1 ],
                    "midpoints": [ 873.5, 60.0, 561.5, 60.0 ],
                    "source": [ "obj-38", 0 ]
                }
            },
            {
